...
//
// The managed region is delimited by <!-- agent-supervisor:start --> /
// <!-- agent-supervisor:end -->. Only that region is replaced; anything outside the
...
const START_MARKER = '<!-- agent-supervisor:start -->';
const END_MARKER = '<!-- agent-supervisor:end -->';
