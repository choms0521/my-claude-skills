---
name: conduct-judge
description: Impartial auditor that grades Claude Code session conduct against a fixed rubric. Read-only. Use when the conduct-coach skill needs a session transcript graded.
model: opus
tools: Read, Grep
---
