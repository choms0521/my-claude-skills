...
## Musical Design (음악 설계)

음악의 뼈대를 설계하는 규칙입니다. **보컬 곡과 Instrumental 모두 동일하게 적용**합니다.
전용 CLI 옵션이 없는 음악 설계 항목(코드 진행, 전조, 다이나믹스, 리듬, 인트로/아웃트로 편곡, 보컬 디렉션)은 `--prompt`에 통합 전달합니다. Key/BPM 등 전용 옵션이 있는 항목은 해당 옵션으로 전달하고 `--prompt`에는 포함하지 않습니다. 가사 파일에는 어떤 음악 설계 항목도 포함하지 않습니다.

### 1. 코드 진행 (Chord Progression)

섹션별 코드 진행을 설계합니다.

**전달 형식:** `Chord progression: Verse: Am - F - C - G, Pre-Chorus: Dm - G - Em - Am, Chorus: F - G - Am - C → F - G - Am, Bridge: Fmaj7 - C/E - Dm7 - Am - G`
...
- 사용자가 Key를 지정하지 않았으면 AI가 분위기에 맞는 Key를 선택

**텐션/컬러 코드:**
- 기본 트라이어드만 나열하지 말고, 장르에 맞는 텐션 코드를 적극 활용
- 팝/발라드: add9, sus4, maj7 (예: Cadd9 - G - Am7 - Fsus2)
- R&B/소울: 7th, 9th, 13th (예: Cmaj7 - Am9 - Dm7 - G13)
- 재즈: ii7-V7-Imaj7, dim, aug (예: Dm7 - G7 - Cmaj7 - A7b9)
- 록/펑크: 파워코드 위주, 단순 진행 (예: C5 - G5 - Am5 - F5)
- Lo-fi/시티팝: 확장 코드 + 크로매틱 경과 (예: Dmaj7 - D#dim7 - Em7 - A7)

### 2. 전조 (Modulation)

곡의 드라마틱한 전환을 위한 전조를 설계합니다.

**전달 형식:** `Modulation: Bridge modulates up half step to Bb minor, final chorus stays in new key`

**설계 원칙:**
- **Bridge 전조**: 반음/온음 올리기가 가장 흔함. 감정 고조 효과
- **Last Chorus 키 체인지**: 마지막 코러스에서 반음 올리면 클라이맥스 극대화
- **피벗 코드 전조**: 공통 코드를 경유하는 자연스러운 전조 (예: Am키 → C키에서 Am을 피벗)
- **직접 전조**: 경과 없이 갑자기 키를 바꾸는 드라마틱한 효과
- 모든 곡에 전조가 필요하진 않음 — 발라드/드라마틱 장르에서 효과적, 루프 기반 장르(Lo-fi, EDM)에서는 생략 가능
- 전조 없음이 적절하면 이 항목을 생략

### 3. 다이나믹스 (Dynamics & Arrangement Flow)

섹션별 악기 레이어링의 빌드업/드랍을 설계합니다.

**전달 형식:** `Dynamics: Verse 1 piano only → Verse 2 add strings and light drums → Pre-Chorus add bass, building intensity → Chorus full band with brass → Bridge strip to piano and vocal → Final Chorus full band + choir`

**설계 원칙:**
- 곡 전체에 걸친 에너지 아크(arc)를 설계
- Intro → Verse: 최소한의 악기로 시작 (공간감 확보)
- Pre-Chorus: 텐션 빌드업 (악기 하나씩 추가, 리듬 밀도 증가)
- Chorus: 에너지 정점 (풀 밴드, 더블링, 레이어링)
- Bridge: 의도적 에너지 드랍 (악기 제거 → 재빌드업)
- Final Chorus: 곡 전체 최고 에너지 (새 악기 추가, 코러스/하모니 강화)
- "벽돌 쌓기" 방식: 같은 에너지가 계속되면 지루함 → 반드시 대비(contrast) 포함

### 4. 리듬 패턴 (Rhythm)

곡의 그루브와 리듬 특성을 지정합니다.

**전달 형식:** `Rhythm: 16th note hi-hat groove with syncopated bass, straight feel on verse, swing feel on bridge`

**설계 원칙:**
- **비트 느낌**: 8th note (발라드, 록), 16th note (팝, R&B, 펑크), triplet (셔플, 스윙)
- **그루브 타입**: straight (직선적), shuffle (셔플), swing (스윙), half-time (하프타임)
- **싱코페이션**: 박자를 엇갈리게 하여 그루브감 부여 (R&B, 펑크에 필수)
- **섹션별 변화**: Verse는 심플 → Chorus는 리듬 밀도 증가 → Bridge는 리듬 변화
- 장르별 기본: 발라드(8th, straight), 팝(8th/16th, straight), R&B(16th, swing), 재즈(swing), 힙합(16th, boom-bap 또는 trap)

### 5. 인트로/아웃트로 편곡

곡의 시작과 마무리를 설계합니다.

**전달 형식:** `Intro: chorus melody preview on piano, 4 bars. Outro: fade out with repeated chorus hook over 8 bars`

**인트로 옵션:**
- 멜로디 선행 제시: Chorus 멜로디를 악기로 먼저 연주 (K-POP에서 흔함)
- 임팩트 시작: 풀 밴드로 강렬하게 시작 후 Verse에서 드랍
- 어쿠스틱/미니멀 시작: 단일 악기 + 분위기 조성
- 페이드인: 점점 볼륨이 커지며 시작
- SFX/앰비언스: 비 소리, 도시 소음 등으로 분위기 진입

**아웃트로 옵션:**
- 페이드아웃: 마지막 코러스 반복하며 점점 사라짐 (클래식한 방식)
- 컷 엔딩: 깔끔하게 끊김 (모던/임팩트)
- 리프리즈(Reprise): Intro 멜로디를 다시 연주하며 마무리 (원형 구조)
- 아웃트로 솔로: 기타/피아노 솔로로 여운
- 어쿠스틱 엔딩: 풀 밴드 → 단일 악기로 축소하며 마무리
...
**--prompt 역할 (중복 방지 원칙):**
`--prompt`에는 **전용 CLI 옵션으로 전달할 수 없는 음악적 지시사항만** 포함합니다:
- 섹션별 보컬 디렉션 (감정 흐름, 음색 변화)
- 코드 진행 + 전조
- 다이나믹스 (악기 레이어링 흐름)
- 리듬 패턴
- 인트로/아웃트로 편곡
- 듀엣/다중 보컬 시 파트 구분 및 교대 지시

**prompt에서 제외하는 항목 (전용 옵션 사용):**
- 장르 → `--genre`
- 분위기 → `--mood`
- 보컬 스타일 → `--vocals`
- 악기 구성 → `--instruments`
...
**가사 파일에는 구조 태그와 순수 가사만 포함:**
- `(vocal direction)`, 코드 기호, 편곡 지시 등을 가사 파일에 넣으면 **mmx가 해당 텍스트를 가사로 인식하여 그대로 노래로 부름** (버그 아님, 사양)
- 보컬 디렉션/코드 진행/다이나믹스 등은 모두 `--prompt`에 전달
...
| 사용 목적 | --use-case |
| 추가 요청 | --extra |
| 음악 설계 (코드 진행, 전조, 다이나믹스, 리듬, 편곡 흐름, 보컬 디렉션) | --prompt |
| 출력 파일 | --out |
...
# 3. mmx CLI 호출 (--prompt에는 음악 설계 + 보컬 디렉션만)
mmx music generate \
  --prompt "Vocal direction: Intro soft humming, barely audible. Verse gentle and restrained with breathy tone. Pre-Chorus gradually building, voice trembling. Chorus powerful belt with raw emotion, full chest voice. Bridge whispered and broken, then rebuilding. Final Chorus explosive with tears in voice. Chord progression: Intro: Am - Fmaj7, Verse: Am - Fmaj7 - Cadd9 - G, Pre-Chorus: Dm7 - G - Em7 - Am, Chorus: F - G - Am - C → F - G - Am, Bridge: Fmaj7 - C/E - Dm7 - Am - Gsus4 - G. Modulation: final chorus up half step to Bbm. Dynamics: Intro piano only → Verse add light strings → Pre-Chorus add bass and drums building → Chorus full band with cello → Bridge strip to piano solo → Final Chorus full band + choir. Rhythm: 8th note ballad feel, straight. Intro: piano arpeggios 4 bars. Outro: fade out with chorus melody on piano." \
...
mmx music generate \
  --prompt "Male-female duet with two distinct vocal timbres alternating. Verse 1 (Female): sweet and playful, light staccato with smiling voice. Verse 2 (Male): warm and gentle, soft low register. Chorus (Both): joyful harmony, female melody + male lower harmony. Chord progression: Verse: G - D/F# - Em7 - Cadd9, Chorus: C - D - G - Em → C - D - G. Dynamics: Verse 1 acoustic guitar only → Verse 2 add piano → Chorus add light percussion and bass. Rhythm: 8th note feel, light swing. Intro: fingerpicked guitar 2 bars. Outro: ritardando on final chord, cut ending." \
  --lyrics-file "$lyrics_file" \
...
```bash
mmx music generate \
  --prompt "Chord progression: Intro: Dmaj7 - D#dim7 - Em7 - A7, Loop: Fmaj7 - Em7 - Dm7 - Cmaj7, Bridge: Am7 - D7 - Gmaj7 - Cmaj7. Dynamics: Intro vinyl crackle + piano → Loop add drums and bass → Bridge add Rhodes and subtle strings → Return to loop with all layers. Rhythm: 16th note hi-hat with lazy swing, boom-bap influenced. Intro: rain ambient + vinyl crackle 4 bars. Outro: fade out over 8 bars, instruments dropping one by one." \
  --instrumental \
  --genre "Lo-fi Hip Hop" \
  --mood "calm, relaxing" \
  --tempo "slow" \
  --instruments "piano, vinyl crackle, soft drums, Rhodes, subtle strings" \
...
- **YouTube 링크 선택지**: Pre-Check에서 `which yt-dlp` 성공 시, AskUserQuestion 선택지에 "YouTube 링크로 참고곡 분석" 옵션을 추가. 사용자가 이 옵션을 선택하면 YouTube URL 입력을 받아 **YouTube Audio Analysis** 절차를 실행. 분석 레이어는 설치된 도구에 따라 자동 선택 (gemini 있으면 청취 분석 추가, ffmpeg/numpy 있으면 신호 분석 추가)
...
- **설계 의도:** 참고곡을 언어/테마보다 먼저 수집하여, Stage 3 음악 설계에 분석 결과를 반영

**Q5. 노래 언어** *(instrumental이면 건너뛰기)*
- 질문: "가사는 어떤 언어로 만들까요?"
- 힌트: 한국어, 영어, 일본어, 한국어+영어 믹스, 일본어+영어 믹스
- CLI: 가사 생성(Stage 5) 시 언어 지시로 사용
- skip 기본값: genre에서 추론 (K-POP → 한국어+영어, J-POP → 일본어+영어, Pop/R&B → 영어)

**Q6. 테마/주제** *(instrumental이면 건너뛰기)*
...
- CLI: 가사 생성(Stage 5) 시 주제 지시로 사용
- skip 기본값: 앞선 답변에서 AI가 가장 적합한 테마를 자동 추론

**Easy 모드 미수집 옵션 처리:**
- `--instruments`: `--genre`와 `--mood`에서 AI가 자동 추론
...
**Q8. 노래 언어** *(instrumental이면 건너뛰기)*
- 질문: "가사는 어떤 언어로 작성할까요?"
- 힌트: 한국어, 영어, 일본어, 한국어+영어 믹스, 일본어+영어 믹스
- CLI: 가사 생성(Stage 5) 시 언어 지시로 사용
- skip 기본값: genre에서 추론 (K-POP → 한국어+영어, J-POP → 일본어+영어, Pop/R&B → 영어)

**Q9. 테마/주제** *(instrumental이면 건너뛰기)*
- 질문: "노래의 주제나 이야기를 알려주세요."
- **선택지: Easy 모드 Q6과 동일한 동적 생성 규칙 적용 + "직접 입력" 옵션**
- CLI: 가사 생성(Stage 5) 시 주제 지시로 사용
- skip 기본값: 앞선 답변에서 AI가 가장 적합한 테마를 자동 추론
...
### Stage 3: 음악 설계 (Musical Design)

모든 질문 완료 후, AI가 인터뷰 답변 + 참고곡 분석 결과를 종합하여 음악의 뼈대를 자동 설계합니다.
**보컬 곡과 Instrumental 모두 동일하게 실행합니다.**

**설계 항목:**
1. **Key 선택** — 사용자 미지정 시 분위기/장르에 맞는 Key를 AI가 선택
2. **섹션별 코드 진행** — 텐션/컬러 코드 포함, 장르 관용 진행 활용
3. **전조 포인트** — 필요 시 Bridge/Final Chorus 전조 설계 (불필요 시 생략)
4. **다이나믹스** — 섹션별 악기 레이어링 빌드업/드랍 흐름
5. **리듬 패턴** — 비트 느낌, 그루브 타입, 섹션별 리듬 변화
6. **인트로/아웃트로 편곡** — 시작과 마무리 스타일

상세 규칙은 "Musical Design (음악 설계)" 섹션을 참조합니다.
설계 결과는 Stage 4 프리뷰에 포함되어 사용자가 검증하고 수정 요청할 수 있습니다.

### Stage 4: 노래 프리뷰 (Song Preview)

음악 설계 완료 후, AI가 수집된 정보를 종합하여 **"이런 노래를 만들겠습니다"라는 자연어 프리뷰**를 작성하여 보여줍니다.
사용자가 결과물을 미리 상상할 수 있도록 구체적이고 감성적으로 묘사합니다.

**프리뷰 구성 규칙:**
- 음악 설계 요약 블록을 상단에 배치 (코드 진행, 전조, 다이나믹스, 리듬, 편곡)
...
🎼 음악 설계
   Key: A minor
   코드 진행: Verse: Am - Fmaj7 - Cadd9 - G | Pre-Chorus: Dm7 - G - Em7 - Am | Chorus: F - G - Am - C → F - G - Am
   전조: Final Chorus → Bbm (반음 상승)
   다이나믹스: Verse(피아노+스트링) → Chorus(풀밴드) → Bridge(피아노솔로) → Final Chorus(풀밴드+합창)
   리듬: 8th note ballad feel, straight
   편곡: 피아노 아르페지오 인트로 / 페이드아웃 아웃트로

"이별의 아픔"을 테마로 한 K-POP Ballad 장르의 감성적인 노래입니다.
맑고 청량한 여성 보컬이 한국어 가사를 부르며,
피아노와 스트링이 서정적인 반주를 만듭니다.
BPM 72의 느린 템포로, 타이틀곡에 어울리는 곡입니다.
...
🎼 음악 설계
   Key: D major
   코드 진행: Intro: Dmaj7 - D#dim7 - Em7 - A7 | Loop: Fmaj7 - Em7 - Dm7 - Cmaj7
   다이나믹스: Intro(비닐크래클+피아노) → Loop(드럼+베이스 추가) → Bridge(로즈+스트링) → Outro(악기 하나씩 빠짐)
   리듬: 16th note hi-hat, lazy swing, boom-bap
   편곡: 빗소리 앰비언스 인트로 / 점진적 페이드아웃

비 오는 날 카페에서 흘러나올 법한 Lo-fi Hip Hop 인스트루멘탈입니다.
피아노와 로즈가 따뜻한 분위기를 만들고,
바이닐 크래클과 부드러운 드럼이 아늑함을 더합니다.
BPM 85의 느린 템포로, 카페 배경음악으로 딱 좋습니다.
...
**수정 요청 처리:**
- 사용자가 자유 텍스트로 수정 요청 (예: "보컬을 좀 더 허스키하게", "기타 대신 피아노로", "좀 더 느리게", "전조 빼줘", "코드를 좀 더 재즈풍으로")
- AI가 해당 파라미터를 반영하여 프리뷰를 다시 생성 (음악 설계 항목도 수정 가능)
- 수정은 **최대 3회**까지 허용
- 3회 초과 시 현재 버전으로 진행
...
- 분위기(--mood): melancholic, heartbreaking
- BPM(--bpm): 72
- Key(--key): A minor
- 보컬(--vocals): clear bright female soprano
- 악기(--instruments): piano, strings, soft drums, cello
- 코드 진행: Verse: Am - Fmaj7 - Cadd9 - G | Chorus: F - G - Am - C → F - G - Am
- 전조: Final Chorus → Bbm
- 다이나믹스: Verse(piano) → Chorus(full band) → Bridge(piano solo) → Final Chorus(full band + choir)
- 리듬: 8th note ballad, straight
- 인트로: piano arpeggios 4 bars
- 아웃트로: fade out with chorus melody
</details>
```
...
Stage 3에서 설계된 음악 뼈대 위에 Claude가 가사를 작성합니다.
...
**음악 설계 연동:**
- 코드 진행의 감정 흐름에 맞춰 가사의 서사를 전개 (예: 텐션 빌드업 구간에 감정 고조 가사)
- 다이나믹스 빌드업에 맞춘 가사 밀도 조절 (예: 미니멀 구간은 짧은 문장, 풀밴드 구간은 밀도 높은 가사)
- 전조 포인트에 맞춰 가사의 감정 전환 (예: 전조 직전 Bridge에 클라이맥스 서사)
...
**진입 조건:**
- Stage 4 프리뷰 검토 완료 (사용자 "확인" 응답)
- Stage 5 가사 확인 완료 (사용자 "확인" 응답, 또는 수정 3회 초과 후 "현재 버전으로 진행합니다." 안내)
- Instrumental 모드인 경우: Stage 4 완료만으로 진입

Direct Mode와 동일한 절차로 CLI를 구성하고 실행합니다:

1. `--prompt` 조합 (필수) — Stage 3 음악 설계(코드 진행, 전조, 다이나믹스, 리듬, 편곡) + 보컬 디렉션을 자연어로 조합. **전용 옵션이 있는 항목(genre, mood, vocals 등)은 prompt에서 제외**
...
| 옵션 | 타입 | 설명 | 본 스킬 사용 여부 |
|------|------|------|------------------|
| `--prompt` | text | 보컬 디렉션, 코드 진행, 전조, 다이나믹스, 리듬, 편곡 흐름 등 전용 옵션으로 전달할 수 없는 음악적 지시사항 **(필수)** | O (항상 생성) |
...
**--prompt 중복 방지 원칙:** `--genre`, `--mood`, `--vocals`, `--instruments`, `--bpm`, `--key` 등 전용 CLI 옵션이 있는 항목은 해당 옵션에만 전달하고 `--prompt`에는 포함하지 않습니다. `--prompt`에는 전용 옵션으로 표현할 수 없는 음악적 지시사항(보컬 디렉션, 코드 진행, 전조, 다이나믹스, 리듬, 편곡 흐름)만 포함합니다.
...
--- 음악 설계 (AI 자동 수행) ---
→ Key: G major, 코드 진행 설계, 다이나믹스 설계, 리듬 설계...
...
🎼 음악 설계
   Key: G major
   코드 진행: Verse: G - D - Em - Cadd9 | Chorus: C - D - G - Em → C - D - G
   다이나믹스: Verse(우쿨렐레+클랩) → Chorus(풀밴드+브라스 샷)
   리듬: 16th note feel, straight with light syncopation
   편곡: 파도소리 앰비언스 인트로 / 컷 엔딩

"여름 바다 여행"을 테마로 한 Summer Pop 장르의 밝고 신나는 노래입니다.
맑고 청량한 여성 보컬이 한국어+영어 믹스 가사를 부르며,
신스와 우쿨렐레가 경쾌한 반주를 만듭니다.
...
사용자: "확인"
→ 곡 제목 질문 → 가사 생성(Stage 5) → CLI 실행(Stage 6)
```
...
--- 음악 설계 (AI 자동 수행) ---
→ Key: D major, 재즈 ii-V-I 기반 코드, 스윙 리듬, 다이나믹스 설계...
...
🎼 음악 설계
   Key: D major
   코드 진행: Intro: Dmaj7 - D#dim7 - Em7 - A7 | Loop: Fmaj7 - Em7 - Dm7 - Cmaj7
   다이나믹스: Intro(비닐크래클+피아노) → Loop(드럼+베이스 추가) → Bridge(색소폰 솔로) → Outro(피아노만 남음)
   리듬: swing feel, brushed drums
   편곡: 빗소리 앰비언스 인트로 / 점진적 페이드아웃
...
사용자: "확인"
→ 곡 제목 질문 → CLI 실행(Stage 6, 가사 생성 건너뜀)
```
...
참고곡 질문(Easy Q4 / Expert Q7)의 답변에서 다음 패턴이 감지될 때:
...
| 사용자가 해당 항목을 질문받지 않음 (Easy 모드) | **검색 결과를 Stage 3 음악 설계에 반영** |
...
참고곡 분석이 수행된 경우, Stage 4 프리뷰 상단에 분석 요약을 포함합니다.
...
🎼 음악 설계
   Key: G major
   코드 진행: Verse: G - Bm7 - C - D | Chorus: C - D - G - Em → C - D - G
   ...
```
...
🎼 음악 설계
   Key: A minor
   코드 진행: Verse: Am - Fmaj7 - C - G | Chorus: F - G - Am7 - C → F - Gsus4 - Am
   ...
```
...
- Expert 모드에서 오디오 품질 옵션(`--format`, `--sample-rate`, `--bitrate`)은 추가 요청사항(Q10)에서 자유 텍스트로 요청 가능
- **--prompt 중복 방지:** `--genre`, `--mood`, `--vocals`, `--instruments` 등 전용 옵션이 있는 항목은 해당 옵션에만 전달하고 `--prompt`에는 포함하지 않습니다
