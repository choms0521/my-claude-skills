...
| **Total** | **60** | **130** | **170** | **360** |

**Grand Total: 360 questions across 36 files, 11 categories**

## Level Recommendations

| Level | Recommended Categories | Files | Questions |
|-------|----------------------|-------|-----------|
| Junior (1-3yr) | JavaScript, HTML/CSS, React | 6 files | 60 questions |
| Mid (4-7yr) | JS, HTML/CSS, React, TypeScript, Performance, Next.js, Testing, Accessibility | 16 files | 190 questions |
| Senior (8yr+) | All categories | 36 files | 360 questions |
