...
- **사이클 2+**: 이전 사이클에서 FIX 후 푸시했으므로 Copilot이 아직 리뷰 중일 수 있습니다. Stage 4 조건 B의 폴링 절차(30초 간격, 최대 7분)를 즉시 시작합니다. 폴링 중 새 코멘트가 발견되면 Stage 2로 진행하고, 7분 경과 후에도 없으면 사용자에게 계속 여부를 묻습니다.
