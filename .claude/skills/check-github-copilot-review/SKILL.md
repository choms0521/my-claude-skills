...
**판단 원칙:**
- 애매한 경우 Copilot의 제안보다 **코드 작성자의 의도와 판단을 우선**합니다. Copilot은 로컬 컨텍스트만 보고 제안하므로, 프로젝트 전체 맥락이나 작성자의 설계 의도를 충분히 반영하지 못할 수 있습니다.

**FIX 판단 기준 (명확한 결함만 수정):**
- 실제 버그나 논리 오류가 있는 경우
- 보안 취약점이 존재하는 경우
- 에러 핸들링이 누락된 경우
- 성능 문제가 명확한 경우
...
- Copilot의 제안이 타당하나, 작성자의 설계 의도와 충돌하여 수용하지 않는 경우
